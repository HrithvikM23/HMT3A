...
RUNTIME_PROFILES: dict[str, RuntimeProfile] = {
    PROFILE_FASTEST: RuntimeProfile(
        ...
        description="Realtime-first mode for live preview and webcams.",
        settings={
            ...
            "hand_det_threshold": 0.25,
            "hand_kp_threshold": 0.25,
            "hand_crop_retries": 0,
            "body_detect_interval": 2,
            "hand_detect_interval": 3,
            "backend_fallbacks": False,
            "body_smoothing_alpha": 0.50,
            "hand_smoothing_alpha": 0.45,
            "body_hold_frames": 4,
            "hand_hold_frames": 8,
            "hold_confidence_decay": 0.90,
            "export_cleanup_smoothing_alpha": 0.45,
            "export_cleanup_max_velocity": 260.0,
        },
    ),
